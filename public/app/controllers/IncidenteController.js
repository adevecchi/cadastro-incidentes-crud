app.controller('IncidenteController', function(dataFactory, $scope, $http) {
    ...
    function getResultsPage(pageNumber) {
        dataFactory.httpRequest('/api/incidentes/pagina/' + pageNumber).then(function(data) {
    ...
    $scope.saveAdd = function() {
        dataFactory.httpRequest('/api/incidentes', 'POST', $scope.form).then(function(data) {
    ...
    $scope.edit = function(id) {
        dataFactory.httpRequest('/api/incidentes/' + id).then(function(data) {
            $scope.form = data;
    ...
    $scope.saveEdit = function() {
        dataFactory.httpRequest('/api/incidentes/' + $scope.form.id, 'PUT', $scope.form).then(function(data) {
    ...
    $scope.removeAction = function() {
        ...
        dataFactory.httpRequest('/api/incidentes/' + id, 'DELETE').then(function(data) {
